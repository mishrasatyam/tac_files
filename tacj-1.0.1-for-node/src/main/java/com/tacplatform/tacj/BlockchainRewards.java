...
public class BlockchainRewards {
    ...
    private final long totalTacAmount;
    ...
    public boolean equals(Object o) {
        ...
        return height == that.height &&
                totalTacAmount == that.totalTacAmount &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(height, totalTacAmount, currentReward, minIncrement, term, nextCheck,
