...
import com.tacplatform.tacj.exceptions.NodeException;
import com.tacplatform.tacj.json.TypeRef;
import com.tacplatform.tacj.json.TacJMapper;
import im.mak.tac.transactions.TacConfig;
import im.mak.tac.transactions.account.Address;
import im.mak.tac.transactions.LeaseTransaction;
import im.mak.tac.transactions.Transaction;
import im.mak.tac.transactions.common.*;
import im.mak.tac.transactions.data.DataEntry;
import im.mak.tac.transactions.serializers.json.JsonSerializer;
...
import static im.mak.tac.transactions.serializers.json.JsonSerializer.JSON_MAPPER;
...
public class Node {
    ...
    private final TacJMapper mapper;
        ...
        this.client = HttpClients
                ...
                .setDefaultRequestConfig(
                        RequestConfig.custom()
                                ...
                                .build())
                .build();
        this.mapper = new TacJMapper();
        this.chainId = getAddresses().get(0).chainId();
        TacConfig.chainId(this.chainId);
    }
