  ...
  function rateSystem(className, obj, fnc=function(){}, fncMove=function(){}, fncLeave=function(){}){
    ...
    for(let i=0; i<obj.length; i++){
      document.getElementsByClassName(className)[i].id = 'starClick';
      ...
      document.getElementsByClassName(className)[i].setAttribute('data-id', obj[i].id);
      ...
      if(obj[i].emptyStarImage){
        document.getElementsByClassName(className)[i].innerHTML = '<div class="emptyStarRating"></div> <div class="rate">Rate this webpage!</div>';
      ...
      document.getElementsByClassName(className)[i].parentElement.addEventListener("mousemove", function(){ zmouseMoveStarRating(fncMove) }, { passive: true });
      document.getElementsByClassName(className)[i].parentElement.addEventListener("click", function(){ zmouseMoveStarRatingClick(fnc) }, { passive: true });
      document.getElementsByClassName(className)[i].parentElement.addEventListener("mouseleave", function(){ zmouseMoveStarRatingLeave(fncLeave) }, { passive: true });
      document.getElementsByClassName(className)[i].parentElement.addEventListener("touchstart", function(){ zmouseMoveStarRatingTouch(fncMove)}, { passive: true });
      document.getElementsByClassName(className)[i].parentElement.addEventListener("touchend", function(){zmouseMoveStarRatingLeaveTouch(fnc, fncLeave)}, { passive: true });
      document.getElementsByClassName(className)[i].parentElement.addEventListener("touchmove", function(){zmouseMoveStarRatingTouchMove(fncMove)}, { passive: true });
    }
  }
  ...
  function zmouseMoveStarRatingClick(fnc){
    if(event.target.classList.contains("starRatingContainer")){
      ...
      if(!event.target.parentElement.classList.contains("readOnlyStarRating")){
        ...
        var w = event.target.parentElement.style.width
        var x = w.substring(0, w.length - 2);
        event.target.parentElement.dataset.rating=(x/parseInt(event.target.parentElement.style.backgroundSize)).toFixed(2);
