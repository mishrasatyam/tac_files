...
//import com.tacplatform.features.EstimatorProvider
...
//import com.tacplatform.protobuf.utils.PBImplicitConversions.PBByteStringOps
//import com.tacplatform.settings.{Constants, TacSettings}
//import com.tacplatform.state.diffs.ENOUGH_AMT
//import com.tacplatform.state.{Blockchain, Diff, NewTransactionInfo}
...
//import com.tacplatform.transaction.{BlockchainUpdater, DataTransaction, GenesisTransaction, Transaction}
//import com.tacplatform.{BlockGen, TestHelpers, crypto, state}
...
//  private val TAC_AMOUNT = Constants.UnitsInTac * Constants.TotalTac
//
...
//  private val initialAmount: Long = TAC_AMOUNT / 2
...
//
//  "updated Tac amount is calculated correctly for miner reward" in forAll {
//    for {
...
//    } yield (reward, ba)
//  } {
//    case (reward, BlockAppended(_, _, _, updatedTacAmount, _, _)) =>
//      updatedTacAmount shouldBe TAC_AMOUNT + reward.getOrElse(0L)
//  }
//
//  "rollbacks correctly" - {
...
//        amount        <- Gen.choose(1L, initialAmount - Constants.UnitsInTac)
//        master2sender <- transferGeneratorPV2(1, master, sender.toAddress, amount)
//        fee           <- Gen.choose(1, master2sender.amount - 1)
//        sender2recipient = TransferTransaction.selfSigned(2.toByte, sender, recipient.toAddress, Tac, master2sender.amount - fee, Tac, fee, ByteStr.empty, 2)
//          .explicitGet()
