...
import com.tacplatform.account.{Address, AddressOrAlias, PublicKey}
import com.tacplatform.block.{Block, MicroBlock}
import com.tacplatform.common.state.ByteStr
import com.tacplatform.common.utils._
import com.tacplatform.events.StateUpdate.LeaseUpdate.LeaseStatus
import com.tacplatform.events.StateUpdate.{AssetStateUpdate, BalanceUpdate, DataEntryUpdate, LeaseUpdate, LeasingBalanceUpdate}
import com.tacplatform.events.protobuf.TransactionMetadata
import com.tacplatform.lang.v1.compiler.Terms
import com.tacplatform.protobuf._
import com.tacplatform.protobuf.transaction.{PBAmounts, PBTransactions}
import com.tacplatform.state.DiffToStateApplier.PortfolioUpdates
import com.tacplatform.state.diffs.BlockDiffer.DetailedDiff
import com.tacplatform.state.reader.CompositeBlockchain
import com.tacplatform.state.{
  AccountDataInfo,
  AssetDescription,
  AssetScriptInfo,
  Blockchain,
...
import com.tacplatform.transaction.{Asset, GenesisTransaction, TxAmount}
...
object StateUpdate {
  ...
  object BalanceUpdate {
    import com.tacplatform.events.protobuf.StateUpdate.{BalanceUpdate => PBBalanceUpdate}
  ...
  object DataEntryUpdate {
    import com.tacplatform.events.protobuf.StateUpdate.{DataEntryUpdate => PBDataEntryUpdate}
  ...
  object LeasingBalanceUpdate {
    import com.tacplatform.events.protobuf.StateUpdate.{LeasingUpdate => PBLeasingUpdate}
  ...
  object LeaseUpdate {
    ...
    import com.tacplatform.events.protobuf.StateUpdate.LeaseUpdate.{LeaseStatus => PBLeaseStatus}
    import com.tacplatform.events.protobuf.StateUpdate.{LeaseUpdate => PBLeaseUpdate}
  ...
  object AssetStateUpdate {
    ...
    import com.tacplatform.events.protobuf.StateUpdate.AssetDetails.{AssetScriptInfo => PBAssetScriptInfo}
    import com.tacplatform.events.protobuf.StateUpdate.{AssetDetails => PBAssetDetails, AssetStateUpdate => PBAssetStateUpdate}
  ...
  object AssetInfo {
    import com.tacplatform.events.protobuf.StateUpdate.{AssetInfo => PBAssetInfo}
  ...
  import com.tacplatform.events.protobuf.{StateUpdate => PBStateUpdate}
  ...
  def container(
    ...
    val parentStateUpdateWithMinerReward = parentStateUpdate.balances.find(_.address == minerAddress) match {
      ...
      case None =>
        val minerBalance = blockchainBeforeWithMinerReward.balance(minerAddress, Tac)
        val reward       = blockchainBeforeWithMinerReward.blockReward(blockchainBeforeWithMinerReward.height).getOrElse(0L)
        parentStateUpdate.copy(balances = parentStateUpdate.balances :+ BalanceUpdate(minerAddress, Tac, minerBalance - reward, minerBalance))
    }
...
object BlockAppended {
  def from(block: Block, diff: DetailedDiff, blockchainBeforeWithMinerReward: Blockchain): BlockAppended = {
    ...
    // updatedTacAmount can change as a result of either genesis transactions or miner rewards
    val updatedTacAmount = blockchainBeforeWithMinerReward.height match {
      // genesis case
      case 0 => block.transactionData.collect { case GenesisTransaction(_, amount, _, _, _) => amount }.sum
      // miner reward case
      case height => blockchainBeforeWithMinerReward.tacAmount(height).toLong
    }
