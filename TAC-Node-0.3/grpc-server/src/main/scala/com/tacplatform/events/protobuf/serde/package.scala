package com.tacplatform.events.protobuf

import cats.Monoid
import com.google.protobuf.ByteString
import com.tacplatform.events.RollbackResult
import com.tacplatform.events.StateUpdate.AssetInfo
import com.tacplatform.events.protobuf.BlockchainUpdated.Append.Body
import com.tacplatform.events.protobuf.BlockchainUpdated.Rollback.RollbackType
import com.tacplatform.events.protobuf.BlockchainUpdated.{Append, Rollback, Update}
import com.tacplatform.protobuf._
import com.tacplatform.protobuf.block.{PBBlocks, PBMicroBlocks}
import com.tacplatform.transaction.Transaction
import com.tacplatform.{events => ve}
              ...
              Append(
                ...
                body = Append.Body.Block(
                  Append.BlockAppend(
                    ...
                    updatedTacAmount = updatedTacAmount
                  )
                )
              )
            ),
            ...
            append.body match {
              case Body.Block(body) =>
                ve.BlockAppended(
                  ...
                  updatedTacAmount = body.updatedTacAmount,
