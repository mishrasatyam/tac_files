...
import com.tacplatform.events.api.grpc.protobuf.BlockchainUpdatesApiGrpc
import com.tacplatform.events.repo.UpdatesRepoImpl
import com.tacplatform.events.settings.BlockchainUpdatesSettings
...
import com.tacplatform.utils.{Schedulers, ScorexLogging}
...
class BlockchainUpdates(private val context: Context) extends Extension with ScorexLogging with BlockchainUpdateTriggers {
  ...
  private[this] val settings = context.settings.config.as[BlockchainUpdatesSettings]("tac.blockchain-updates")
