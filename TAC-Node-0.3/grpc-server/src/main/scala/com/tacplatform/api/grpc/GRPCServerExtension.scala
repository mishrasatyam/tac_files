...
import com.tacplatform.extensions.{Extension, Context => ExtensionContext}
import com.tacplatform.settings.GRPCSettings
...
class GRPCServerExtension(context: ExtensionContext) extends Extension with ScorexLogging {
  ...
  private val settings                         = context.settings.config.as[GRPCSettings]("tac.grpc")
