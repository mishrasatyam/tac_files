...
import com.tacplatform.lang.v1.compiler.Terms.{CONST_LONG, CONST_STRING, FUNCTION_CALL}
import com.tacplatform.lang.v1.evaluator.ScriptResultV3
import com.tacplatform.lang.v1.traits.domain.DataItem.Lng
import com.tacplatform.lang.v1.traits.domain.{AssetTransfer, Recipient}
  ...
  private val tx = (
    for {
      ...
      tx <- InvokeScriptTransaction.create(
        ...
        p = List(InvokeScriptTransaction.Payment(1L, Tac)),
        fee = 10000000L,
        feeAssetId = Tac,
        timestamp = 1111L,
