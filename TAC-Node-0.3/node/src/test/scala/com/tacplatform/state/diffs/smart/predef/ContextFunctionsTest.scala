...
import com.tacplatform.features.BlockchainFeatures.{BlockV5, FeeSponsorship, SynchronousCalls}
import com.tacplatform.lagonaki.mocks.TestBlock._
...
import com.tacplatform.lang.v1.compiler.{ContractCompiler, ExpressionCompiler, Terms, TestCompiler}
  ...
  private val preconditionsAndPayments = for {
    ...
    untypedScript <- Gen
      ...
      .map {
        ...
        case 2 => scriptWithV1TacFunctions(dataTransaction, transfer)
