...
import com.tacplatform.lang.v1.evaluator.FunctionIds.TO_BIGINT
    ...
    val preconditions =
      for {
        ...
        invoke = InvokeScriptTransaction
          .selfSigned(1.toByte, dApp1Acc, dApp1Acc.toAddress, Some(FUNCTION_CALL(User("default"), Nil)), Nil, fee, Tac, ts)
          .explicitGet()
