...
import com.tacplatform.lang.directives.values.{StdLibVersion, V4, V5}
...
class CallableV5LimitTest
  ...
  private val scenario =
    for {
      ...
      invoke                = InvokeScriptTransaction.selfSigned(TxVersion.V3, invoker, dApp.toAddress, None, Nil, fee, Tac, ts).explicitGet()
      syncInvoke            = InvokeScriptTransaction.selfSigned(TxVersion.V3, invoker, syncDApp.toAddress, None, Nil, fee, Tac, ts).explicitGet()
