...
import com.tacplatform.api.http.ApiError.TooBigArrayAllocation
import com.tacplatform.api.http.ApiMarshallers._
import com.tacplatform.api.http.UtilsApiRoute
import com.tacplatform.api.http.requests.ScriptWithImportsRequest
...
import com.tacplatform.lang.directives.values.{V2, V3}
...
import com.tacplatform.state.{AccountScriptInfo, Blockchain, IntegerDataEntry}
...
import com.tacplatform.utils.{Schedulers, Time}
...
class UtilsRouteSpec extends RouteSpec("/utils") with RestAPISettingsHelper with PropertyChecks with PathMockFactory {
  ...
  routePath("/script/compileCode") in {
    ...
    Post(routePath("/script/compileCode"), dApp) ~> route ~> check {
      ...
      (json \ "callableComplexities").as[Map[String, Int]] shouldBe Map("write" -> 27, "sendAsset" -> 66, "writeAndSendTac" -> 68)
      (json \ "extraFee").as[Long] shouldBe FeeValidation.ScriptExtraFee
    }
