...
package object history {
  ...
  val MicroblocksActivatedAt0TacSettings: TacSettings        = settingsWithFeatures(BlockchainFeatures.NG)
  val DataAndMicroblocksActivatedAt0TacSettings: TacSettings = settingsWithFeatures(BlockchainFeatures.DataTransaction, BlockchainFeatures.NG)
  val TransfersV2ActivatedAt0TacSettings: TacSettings        = settingsWithFeatures(BlockchainFeatures.SmartAccounts)
  ...
  val DefaultTacSettings: TacSettings = settings.copy(
