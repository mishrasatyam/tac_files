...
import com.tacplatform.{database, Application}
import com.tacplatform.account.Address
import com.tacplatform.api.BlockMeta
import com.tacplatform.api.common.{AddressPortfolio, AddressTransactions, CommonBlocksApi, CommonTransactionsApi}
...
import com.tacplatform.consensus.nxt.NxtLikeConsensusBlockData
import com.tacplatform.database.{DBExt, Keys, LevelDBWriter}
...
import com.tacplatform.transaction.{BlockchainUpdater, _}
...
case class Domain(db: DB, blockchainUpdater: BlockchainUpdaterImpl, levelDBWriter: LevelDBWriter, settings: TacSettings) {
  import Domain._
