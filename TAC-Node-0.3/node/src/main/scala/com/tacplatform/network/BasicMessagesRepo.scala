...
import com.tacplatform.mining.Miner.MaxTransactionsPerMicroblock
import com.tacplatform.mining.MiningConstraints
import com.tacplatform.network.message.Message._
import com.tacplatform.network.message._
import com.tacplatform.protobuf.block.{PBBlock, PBBlocks, PBMicroBlocks, SignedMicroBlock}
import com.tacplatform.protobuf.transaction.{PBSignedTransaction, PBTransactions}
import com.tacplatform.transaction.{DataTransaction, Transaction, TransactionParsers}
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://tacplatform.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
