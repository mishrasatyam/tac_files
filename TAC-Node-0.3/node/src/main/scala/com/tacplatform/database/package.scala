...
import com.tacplatform.account.{AddressScheme, PublicKey}
...
import com.tacplatform.database.{protobuf => pb}
import com.tacplatform.database.protobuf.DataEntry.Value
import com.tacplatform.lang.script.{Script, ScriptReader}
import com.tacplatform.protobuf.ByteStringExt
...
import com.tacplatform.transaction.{GenesisTransaction, LegacyPBSwitch, PaymentTransaction, Transaction, TransactionParsers, TxValidationError}
import com.tacplatform.transaction.Asset.IssuedAsset
import com.tacplatform.transaction.lease.LeaseTransaction
import com.tacplatform.utils.{ScorexLogging, _}
...
package object database extends ScorexLogging {
  ...
  implicit class EntryExt(val e: JMap.Entry[Array[Byte], Array[Byte]]) extends AnyVal {
    import com.tacplatform.crypto.DigestLength
