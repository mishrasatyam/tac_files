...
import com.tacplatform.utils.{ScorexLogging, base58Length}
...
object Address extends ScorexLogging {
  ...
  private[tacplatform] def createUnsafe(addressBytes: Array[Byte]): Address = new Address {
