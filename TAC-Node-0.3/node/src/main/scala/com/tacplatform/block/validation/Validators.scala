package com.tacplatform.block.validation

import cats.syntax.either._
import com.tacplatform.block.Block.{GenerationSignatureLength, GenerationVRFSignatureLength, MaxFeaturesInBlock, ProtoBlockVersion}
...
import com.tacplatform.settings.GenesisSettings
