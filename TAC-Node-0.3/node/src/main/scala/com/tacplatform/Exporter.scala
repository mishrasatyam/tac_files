...
import com.tacplatform.database.{DBExt, openDB}
...
import com.tacplatform.state.Height
...
object Exporter extends ScorexLogging {
  private[tacplatform] object Formats {
    val Binary   = "BINARY"
  ...
  private[this] lazy val commandParser = {
    ...
    OParser.sequence(
      programName("tac export"),
      head("Tac Blockchain Exporter", Version.VersionString),
      opt[File]('c', "config")
