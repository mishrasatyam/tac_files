...
import com.tacplatform.crypto.{DigestLength, SignatureLength}
...
import com.tacplatform.transaction.{Asset, AssetIdStringLength, Proofs, TxValidationError, TxVersion}
...
package object requests {
  ...
  implicit val byteStrFormat: Format[ByteStr] = com.tacplatform.utils.byteStrFormat
