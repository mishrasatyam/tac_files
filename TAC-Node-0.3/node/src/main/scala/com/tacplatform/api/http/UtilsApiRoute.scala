...
import com.tacplatform.api.http.ApiError.{CustomValidationError, ScriptCompilerError, TooBigArrayAllocation}
import com.tacplatform.api.http.requests.{byteStrFormat, ScriptWithImportsRequest}
...
import com.tacplatform.lang.{Global, ValidationError}
...
import com.tacplatform.lang.script.Script.ComplexityInfo
import com.tacplatform.lang.v1.{ContractLimits, Serde}
import com.tacplatform.lang.v1.compiler.ExpressionCompiler
import com.tacplatform.lang.v1.compiler.Terms.{EVALUATED, EXPR}
import com.tacplatform.lang.v1.estimator.ScriptEstimator
import com.tacplatform.lang.v1.evaluator.{ContractEvaluator, EvaluatorV2}
...
import com.tacplatform.serialization.ScriptValuesJson
...
import com.tacplatform.transaction.TxValidationError.{GenericError, ScriptExecutionError}
import com.tacplatform.transaction.smart.{BlockchainContext, DAppEnvironment}
    ...
    def compile(stdLibVersion: StdLibVersion)(str: String): Either[GenericError, EXPR] = {
      val ctx =
        PureContext.build(stdLibVersion).withEnvironment[Environment] |+|
          ...
          TacContext.build(Global, DirectiveSet(stdLibVersion, Account, Expression).explicitGet())
