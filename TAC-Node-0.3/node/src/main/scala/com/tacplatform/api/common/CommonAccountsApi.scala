...
import com.tacplatform.api.common
import com.tacplatform.api.common.AddressPortfolio.{assetBalanceIterator, nftIterator}
import com.tacplatform.api.common.CommonTransactionsApi.TransactionMeta
import com.tacplatform.common.state.ByteStr
import com.tacplatform.common.utils.EitherExt2
import com.tacplatform.database
import com.tacplatform.database.{DBExt, Keys, KeyTags}
import com.tacplatform.features.BlockchainFeatures
import com.tacplatform.lang.ValidationError
import com.tacplatform.state.{AccountScriptInfo, AssetDescription, Blockchain, DataEntry, Diff, Height, InvokeScriptResult}
import com.tacplatform.state.reader.LeaseDetails
import com.tacplatform.state.reader.LeaseDetails.Status
...
object CommonAccountsApi extends ScorexLogging {
  ...
  def apply(diff: => Diff, db: DB, blockchain: Blockchain): CommonAccountsApi = new CommonAccountsApi {
    ...
    override def balanceDetails(address: Address): BalanceDetails = {
      val portfolio = blockchain.tacPortfolio(address)
      BalanceDetails(
        portfolio.balance,
