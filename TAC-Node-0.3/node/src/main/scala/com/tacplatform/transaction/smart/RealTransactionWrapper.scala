...
import com.tacplatform.lang.v1.traits.domain.Tx.{Header, Proven}
...
import com.tacplatform.transaction.assets.exchange.OrderType.{BUY, SELL}
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
            ...
            transfers = ms.transfers.map(r => com.tacplatform.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
