...
import com.tacplatform.block.Block.{BlockId, GenesisBlockVersion, NgBlockVersion, PlainBlockVersion, ProtoBlockVersion, RewardBlockVersion}
import com.tacplatform.block.{Block, BlockHeader, SignedBlockHeader}
import com.tacplatform.common.state.ByteStr
import com.tacplatform.consensus.GeneratingBalanceProvider
import com.tacplatform.features.{BlockchainFeature, BlockchainFeatureStatus, BlockchainFeatures}
import com.tacplatform.lang.ValidationError
import com.tacplatform.lang.v1.ContractLimits
import com.tacplatform.lang.v1.traits.domain.Issue
...
trait Blockchain {
  ...
  def tacAmount(height: Int): BigInt
  ...
  def balanceAtHeight(address: Address, height: Int, assetId: Asset = Tac): Option[(Int, Long)]
  ...
  def balance(address: Address, mayBeAssetId: Asset = Tac): Long
}
...
object Blockchain {
  implicit class BlockchainExt(private val blockchain: Blockchain) extends AnyVal {
    ...
    def tacPortfolio(address: Address): Portfolio = Portfolio(
