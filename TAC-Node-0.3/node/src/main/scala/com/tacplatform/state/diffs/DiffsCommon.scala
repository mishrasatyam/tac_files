...
import com.tacplatform.features.ComplexityCheckPolicyProvider._
...
import com.tacplatform.state.{AssetVolumeInfo, Blockchain, Diff, LeaseBalance, Portfolio, SponsorshipValue}
...
object DiffsCommon {
  ...
  def processLease(
    ...
    for {
      ...
      senderBalance   = blockchain.balance(senderAddress, Tac)
