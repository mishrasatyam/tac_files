...
import com.tacplatform.state.diffs.BlockDiffer.Fraction
...
object Portfolio {
  ...
  implicit class PortfolioExt(val self: Portfolio) extends AnyVal {
    ...
    def assetIds: Set[Asset] = self.assets.keySet ++ Set(Tac)
