...
import com.tacplatform.settings.UtxSettings
...
import com.tacplatform.transaction.TxValidationError.{AlreadyInTheState, GenericError, SenderIsBlacklisted}
...
import com.tacplatform.utils.{LoggerFacade, Schedulers, ScorexLogging, Time}
...
class UtxPoolImpl(
  ...
  import com.tacplatform.utx.UtxPoolImpl._
