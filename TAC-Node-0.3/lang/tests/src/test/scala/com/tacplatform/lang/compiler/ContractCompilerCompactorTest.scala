...
import com.tacplatform.lang.directives.{Directive, DirectiveParser, DirectiveSet}
import com.tacplatform.lang.script.ScriptPreprocessor
import com.tacplatform.lang.v1.FunctionHeader.{Native, User}
import com.tacplatform.lang.v1.compiler
import com.tacplatform.lang.v1.compiler.Terms._
import com.tacplatform.lang.v1.compiler.{ContractScriptCompactor, Terms}
...
import com.tacplatform.protobuf.dapp.DAppMeta.{CallableFuncSignature, CompactNameAndOriginalNamePair}
  ...
  property("contract script compaction - V3") {
    ...
    val ctx =
      PureContext.build(stdLibVer).withEnvironment[Environment] |+|
        TacContext.build(Global, DirectiveSet(stdLibVer, Account, DAppType).explicitGet())
