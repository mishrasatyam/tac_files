...
import com.tacplatform.lang.v1.evaluator.EvaluatorV1._
...
import com.tacplatform.lang.v1.evaluator.ctx.impl.{CryptoContext, EnvironmentFunctions, PureContext, _}
import com.tacplatform.lang.v1.evaluator.{Contextful, ContextfulVal, EvaluatorV1, EvaluatorV2, FunctionIds, Log}
import com.tacplatform.lang.v1.testing.ScriptGen
import com.tacplatform.lang.v1.traits.Environment
import com.tacplatform.lang.v1.{CTX, ContractLimits, FunctionHeader}
import com.tacplatform.lang.{Common, EvalF, ExecutionError, Global}
...
class EvaluatorV1V2Test extends PropSpec with PropertyChecks with Matchers with ScriptGen with NoShrink with EitherValues {
  ...
  private def recArrWeight(script: String): Either[ExecutionError, EVALUATED] = {
    ...
    com.tacplatform.lang.v1.parser.Parser.parseExpr(script) match {
