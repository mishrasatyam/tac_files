...
import com.tacplatform.lang.v1.compiler.Types.{BYTESTR, FINAL, LONG}
import com.tacplatform.lang.v1.compiler.{ExpressionCompiler, Terms}
import com.tacplatform.lang.v1.evaluator.Contextful.NoContext
import com.tacplatform.lang.v1.evaluator.ctx._
import com.tacplatform.lang.v1.evaluator.ctx.impl.PureContext.MaxListLengthV4
...
import com.tacplatform.lang.v1.evaluator.{Contextful, ContextfulVal, EvaluatorV2}
...
import com.tacplatform.lang.v1.traits.domain.{Issue, Lease}
...
class IntegrationTest extends PropSpec with PropertyChecks with ScriptGen with Matchers with NoShrink with Inside {
  ...
  private val v5Ctx = TacContext.build(Global, DirectiveSet(V5, Account, DApp).explicitGet())
  ...
  property("callable V3 syntax absent at V4") {
    ...
    val ctx = TacContext.build(Global, DirectiveSet(V4, Account, DApp).explicitGet())
