...
import com.tacplatform.lang.directives.Directive.extractDirectives
import com.tacplatform.lang.directives.values.{DApp => DAppType, _}
import com.tacplatform.lang.directives.{DirectiveDictionary, DirectiveParser, DirectiveSet}
import com.tacplatform.lang.script.ScriptPreprocessor
import com.tacplatform.lang.v1.BaseGlobal.DAppInfo
...
import com.tacplatform.lang.v1.repl.Repl
import com.tacplatform.lang.v1.repl.node.http.NodeConnectionSettings
import com.tacplatform.lang.v1.traits.Environment
import com.tacplatform.lang.v1.{CTX, ContractLimits}
import com.tacplatform.lang.{Global, Version}
...
object JsAPI {
  ...
  private def tacContext(v: StdLibVersion, isTokenContext: Boolean, isContract: Boolean) =
    TacContext.build(
      Global,
  ...
  private def buildScriptContext(v: StdLibVersion, isTokenContext: Boolean, isContract: Boolean): CTX[Environment] =
    Monoid.combineAll(Seq(pureContext(v), cryptoContext(v), tacContext(v, isTokenContext, isContract)))

  private def buildContractContext(v: StdLibVersion): CTX[Environment] =
    Monoid.combineAll(Seq(pureContext(v), cryptoContext(v), tacContext(v, false, true)))
