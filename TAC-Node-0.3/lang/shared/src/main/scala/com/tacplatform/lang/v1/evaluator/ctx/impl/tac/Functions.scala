package com.tacplatform.lang.v1.evaluator.ctx.impl.tac
...
import com.tacplatform.lang.v1.{BaseGlobal, FunctionHeader}
...
import com.tacplatform.lang.v1.evaluator.{ContextfulNativeFunction, ContextfulUserFunction}
import com.tacplatform.lang.v1.evaluator.FunctionIds._
import com.tacplatform.lang.v1.evaluator.ctx.{BaseFunction, NativeFunction, UserFunction}
import com.tacplatform.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext, notImplemented, unit}
import com.tacplatform.lang.v1.evaluator.ctx.impl.converters._
import com.tacplatform.lang.v1.evaluator.ctx.impl.tac.Bindings.{scriptTransfer => _, _}
import com.tacplatform.lang.v1.evaluator.ctx.impl.tac.Types.{addressOrAliasType, addressType, commonDataEntryType, optionAddress, _}
import com.tacplatform.lang.v1.traits.{DataType, Environment}
import com.tacplatform.lang.v1.traits.domain.{Issue, Lease, Recipient}
...
object Functions {
  ...
  val tacBalanceV4F: BaseFunction[Environment] =
    NativeFunction.withEnvironment[Environment](
      "tacBalance",
      10,
      ACCOUNTTACBALANCE,
      ...
      new ContextfulNativeFunction[Environment]("tacBalance", LONG, Seq(("addressOrAlias", addressOrAliasType))) {
        override def ev[F[_]: Monad](input: (Environment[F], List[EVALUATED])): F[Either[ExecutionError, EVALUATED]] =
          input match {
            case (env, (c: CaseObj) :: Nil) =>
              env
                .accountTacBalanceOf(caseObjToRecipient(c))
                .map(
                  _.map(
                    b =>
                      CaseObj(
            ...
            case (_, xs) => notImplemented[F, EVALUATED](s"tacBalance(a: Address|Alias)", xs)
          }
      }
    }
  ...
  val tacBalanceF: BaseFunction[Environment] =
    UserFunction("tacBalance", 109, LONG, ("@addressOrAlias", addressOrAliasType)) {
