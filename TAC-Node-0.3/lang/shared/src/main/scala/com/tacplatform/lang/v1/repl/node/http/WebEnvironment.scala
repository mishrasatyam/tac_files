package com.tacplatform.lang.v1.repl.node.http

import cats.implicits._
import cats.{Functor, Id}
import com.tacplatform.common.state.ByteStr
import com.tacplatform.common.utils.{Base58, EitherExt2}
import com.tacplatform.lang.v1.repl.node.http.NodeClient._
import com.tacplatform.lang.v1.repl.node.http.response.ImplicitMappings
import com.tacplatform.lang.v1.repl.node.http.response.model.Transaction._
...
private[repl] case class WebEnvironment(settings: NodeConnectionSettings) extends Environment[Future] {
  ...
  override def accountTacBalanceOf(
      recipient: Recipient
