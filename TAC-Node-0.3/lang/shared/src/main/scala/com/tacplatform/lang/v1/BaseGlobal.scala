...
import com.tacplatform.lang.ValidationError.ScriptParseError
import com.tacplatform.lang.contract.meta.{FunctionSignatures, MetaMapper, ParsedMeta}
import com.tacplatform.lang.contract.{ContractSerDe, DApp}
import com.tacplatform.lang.directives.values.{Expression, StdLibVersion, V1, V2, DApp => DAppType}
import com.tacplatform.lang.script.ContractScript.ContractScriptImpl
...
import com.tacplatform.lang.v1.BaseGlobal.{ArrayView, DAppInfo}
import com.tacplatform.lang.v1.compiler.CompilationError.Generic
import com.tacplatform.lang.v1.compiler.Terms.EXPR
import com.tacplatform.lang.v1.compiler.Types.FINAL
import com.tacplatform.lang.v1.compiler.{CompilationError, CompilerContext, ContractCompiler, ExpressionCompiler}
...
import com.tacplatform.lang.v1.evaluator.ctx.impl.Rounding
import com.tacplatform.lang.v1.evaluator.ctx.impl.crypto.RSA.DigestAlgorithm
import com.tacplatform.lang.v1.parser.Expressions
import com.tacplatform.lang.v1.parser.Expressions.Pos.AnyPos
import com.tacplatform.lang.v1.repl.node.http.response.model.NodeResponse
...
trait BaseGlobal {
  ...
  def parseAndCompileExpression(
    ...
    (for {
      ...
      illegalBlockVersionUsage              = letBlockOnly && com.tacplatform.lang.v1.compiler.containsBlockV2(compExpr)
  ...
  def checkExpr(
    ...
    for {
      ...
      illegalBlockVersionUsage = LetBlockVersions.contains(version) &&
        com.tacplatform.lang.v1.compiler.containsBlockV2(expr)
      _ <- Either.cond(
