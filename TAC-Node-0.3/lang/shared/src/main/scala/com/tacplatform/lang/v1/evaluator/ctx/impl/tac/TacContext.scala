...
import com.tacplatform.lang.v1.evaluator.ctx.impl.tac.Functions.{addressFromStringF, _}
import com.tacplatform.lang.v1.evaluator.ctx.impl.tac.Types._
import com.tacplatform.lang.v1.evaluator.ctx.impl.tac.Vals._
...
object TacContext {
  ...
  private def variableTypes(version: StdLibVersion, proofsEnabled: Boolean) =
    buildTacTypes(proofsEnabled, version) ++
