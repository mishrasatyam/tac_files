...
import com.tacplatform.features.api.NodeFeatureStatus
...
import com.tacplatform.it.{Docker, ReportingTestName}
...
object PreActivatedFeaturesTestSuite {
  ...
  private val supportedConfig    = ConfigFactory.parseString(s"""tac {
                                                             ...
                                                             |  miner.quorum = 1
                                                             |}""".stripMargin)
  private val preactivatedConfig = ConfigFactory.parseString(s"""tac {
                                                                |  blockchain.custom.functionality {
                                                                |  feature-check-blocks-period = $votingInterval
                                                                |  pre-activated-features {
                                                                |        1 = 0
