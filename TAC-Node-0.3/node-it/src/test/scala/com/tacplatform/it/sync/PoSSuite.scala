...
import com.tacplatform.consensus.FairPoSCalculator
import com.tacplatform.consensus.nxt.NxtLikeConsensusBlockData
import com.tacplatform.crypto
import com.tacplatform.it.api.AsyncNetworkApi.NodeAsyncNetworkApi
import com.tacplatform.it.api.SyncHttpApi._
import com.tacplatform.it.transactions.NodesFromDocker
import com.tacplatform.it.{NodeConfigs, WaitForHeight2}
import com.tacplatform.network.RawBytes
...
class PoSSuite extends FunSuite with Matchers with NodesFromDocker with WaitForHeight2 with CancelAfterFailure {
  ...
  override protected def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .withDefault(3)
      .withSpecial(_.raw("tac.miner.enable = yes"))
      .buildNonConflicting()
