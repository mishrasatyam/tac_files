package com.tacplatform.it.sync.utils
...
import com.tacplatform.state.{BinaryDataEntry, BooleanDataEntry, IntegerDataEntry}
...
import com.tacplatform.transaction.{CreateAliasTransaction, DataTransaction, Proofs, Transaction, TxVersion}
  ...
  lazy val mass = MassTransferTransaction
    .create(
      ...
      MassTransferTransaction
        .parseTransfersList(List(Transfer(firstKeyPair.toAddress.toString, 1.tac), Transfer(secondKeyPair.toAddress.toString, 2.tac)))
        .explicitGet(),
      2.tac,
      ts,
