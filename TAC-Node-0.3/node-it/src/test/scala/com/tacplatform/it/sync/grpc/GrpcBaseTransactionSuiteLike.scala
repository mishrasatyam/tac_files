...
import com.tacplatform.it.{ExternalNode, GrpcIntegrationSuiteWithThreeAddress, GrpcWaitForHeight, Node, NodeConfigs}
...
trait GrpcBaseTransactionSuiteLike
  ...
  protected lazy val theNodes: Coeval[Seq[Node]] = Coeval.evalOnce {
    Option(System.getProperty("tac.it.config.file")) match {
