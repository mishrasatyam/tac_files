...
import com.tacplatform.api.http.ApiError.{CustomValidationError, InvalidName, NonPositiveAmount, TooBigArrayAllocation}
import com.tacplatform.it.api.IssueTransactionInfo
...
class IssueTransactionSuite extends BaseTransactionSuite with TableDrivenPropertyChecks {
  test("asset issue changes issuer's asset balance; issuer's tac balance is decreased by fee") {
