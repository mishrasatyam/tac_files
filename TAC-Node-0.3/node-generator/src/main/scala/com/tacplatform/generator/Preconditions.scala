...
import com.tacplatform.transaction.{Transaction, TxVersion}
          ...
          action match {
            ...
            case CreateAccountP(seed, balance, scriptOption) =>
              ...
              val transferTx = TransferTransaction
                .selfSigned(2.toByte, settings.faucet, acc.toAddress, Tac, balance, Tac, Fee, ByteStr.empty, time.correctedTime())
                .explicitGet()
