...
import com.tacplatform.generator.GeneratorSettings.NodeAddress
import com.tacplatform.generator.Preconditions.{PGenSettings, UniverseHolder}
import com.tacplatform.generator.cli.ScoptImplicits
import com.tacplatform.generator.config.FicusImplicits
import com.tacplatform.generator.utils.Universe
import com.tacplatform.network.client.NetworkSender
...
import com.tacplatform.utils.{LoggerFacade, NTP}
...
object TransactionsGeneratorApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  // IDEA bugs
  implicit val inetSocketAddressReader: ValueReader[InetSocketAddress] = com.tacplatform.settings.inetSocketAddressReader
  ...
  val parser = new OptionParser[GeneratorSettings]("generator") {
    head("TransactionsGenerator - Tac load testing transactions generator")
  ...
  parser.parse(args, defaultConfig) match {
    ...
    case Some(finalConfig) =>
      ...
      val estimator = tacSettings.estimator
      ...
      val sender = new NetworkSender(tacSettings.networkSettings.trafficLogger, finalConfig.addressScheme, "generator", nonce = Random.nextLong())
