...
object Dependencies {
  ...
  private[this] val protoSchemasLib =
    "com.tacplatform" % "protobuf-schemas" % "1.3.1" classifier "proto" intransitive ()
  ...
  val curve25519             = "com.tacplatform" % "curve25519-java" % "0.6.4"
  ...
  private[this] val levelDBJNA = {
    val levelDbVersion = "1.22.2"
    Seq(
      "com.tacplatform.leveldb-jna" % "leveldb-jna-core"   % levelDbVersion,
      "com.tacplatform.leveldb-jna" % "leveldb-jna-native" % levelDbVersion
    )
  }
