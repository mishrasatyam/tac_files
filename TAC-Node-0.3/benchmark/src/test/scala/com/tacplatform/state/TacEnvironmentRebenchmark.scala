...
import com.tacplatform.database.{DBExt, KeyTags, Keys}
import com.tacplatform.lang.v1.traits.DataType
import com.tacplatform.lang.v1.traits.DataType.{Boolean, ByteArray, Long}
...
class TacEnvironmentRebenchmark {
  import TacEnvironmentRebenchmark._
  ...
  @Benchmark
  def tacBalanceOf(bh: Blackhole, st: St): Unit = {
    val useUnexisting = Random.nextBoolean()
    if (useUnexisting) {
...
object TacEnvironmentRebenchmark {
