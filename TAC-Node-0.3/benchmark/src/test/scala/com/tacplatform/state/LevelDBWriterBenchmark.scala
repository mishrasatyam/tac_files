...
import com.tacplatform.database.{DBExt, Keys, LevelDBFactory, LevelDBWriter}
import com.tacplatform.settings.{TacSettings, loadConfig}
import com.tacplatform.state.LevelDBWriterBenchmark._
...
object LevelDBWriterBenchmark {
  ...
  class BaseSt {
    ...
    val db = LevelDBWriter.readOnly(rawDB, tacSettings)
