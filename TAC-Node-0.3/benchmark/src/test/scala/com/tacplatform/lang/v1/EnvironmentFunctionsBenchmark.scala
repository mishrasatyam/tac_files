...
import com.tacplatform.lang.directives.values.{Account, DApp, V4}
import com.tacplatform.lang.script.Script
import com.tacplatform.lang.v1.EnvironmentFunctionsBenchmark._
import com.tacplatform.lang.v1.compiler.Terms.{CONST_STRING, EVALUATED, EXPR, FUNCTION_CALL}
import com.tacplatform.lang.v1.evaluator.EvaluatorV2
import com.tacplatform.lang.v1.evaluator.ctx.EvaluationContext
import com.tacplatform.lang.v1.evaluator.ctx.impl.EnvironmentFunctions
import com.tacplatform.lang.v1.evaluator.ctx.impl.tac.{Functions, TacContext}
...
import com.tacplatform.lang.{Common, Global}
...
class AddressFromString {
  val ctx: EvaluationContext[Environment, Id] =
    TacContext.build(Global, DirectiveSet(V4, Account, DApp).explicitGet())
